...
# Sem imports externos no escopo global para permitir importações puras dos dados do grafo
...
if __name__ == '__main__':
    # Auto-bootstrap para execução direta
    try:
        ...
        if os.path.exists(venv_python) and sys.executable != venv_python:
            ...
            print("Erro: Instale as bibliotecas necessárias para plotar o grafo: pip install networkx matplotlib")
            sys.exit(1)
